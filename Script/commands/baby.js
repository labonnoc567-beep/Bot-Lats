...
const SHIZUKA_UID = "100070782965051";
const SHIZUKA_NAMES = ["shi zuka", "sizuka", "shizuka", "Princess", " Monika", "princess Monika", " মনিকা", "মনি", " Monika", "Moni"];
...
const smartReplies = [
  "কি রে! তুই এতো cute কেন? 🤭", "তোর msg দেখেই হাসি পেলো! 😁", "আমার তোকে ছাড়া চলবে না, জানিস তো? 🥺",
  "তুই কি সবসময় আমার কথা ভাবিস নাকি? 😜", "তোর কোনো কথার উত্তর না দিলেই কষ্ট পাবি?", "আবারও একবার জিজ্ঞাস কর! 😏",
...
const contextualReplies = {
  ...
  " ki koros","keros", "ki koro",: ["চা খাই তুই😋?", " চিপায় বসে আছি", "তোকে কেন বলবো"," চুপ কর"]
};
